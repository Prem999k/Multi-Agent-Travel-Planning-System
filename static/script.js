...
function showWorkflow(data) {
    ...
    if (!section || !reasoning || !chips || !guardrailBadge) {
        return;
    }
...
async function submitApproval(approved) {
    ...
    if (!currentThreadId) {
        showError(
            "There is no travel planning thread available."
        );
        return;
    }
